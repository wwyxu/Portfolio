...
import { skillList1, skillList2, skillList3 } from "./data";
        ...
        <div className="container p-5">
          ...
          <div className="row pb-1 skill-fade">
            ...
            <div className="card-deck">
              ...
              non-relational databases. I use MongoDB, PostegreSQL and SQLite."
              />
              <SkillCard
                name="Testing"
                delay={400}
                ...
                I use Jest and Java to create automated tests."
              />
            </div>
          </div>
        </div>
